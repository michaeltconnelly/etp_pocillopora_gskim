...
printf '/share/apps/bioinformatics/angsd/0.941/angsd/misc/realSFS saf2theta ${angsddir}/1dsfs/%s.saf.idx -sfs ${angsddir}/1dsfs/%s.folded.ml -outname ${angsddir}/thetas/%s -fold 1 \n' "$pop1" "$pop1" "$pop1" >> $JOBFILE
