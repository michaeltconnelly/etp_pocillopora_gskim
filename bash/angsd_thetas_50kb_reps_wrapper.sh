#!/bin/bash
#./bash/angsd_thetas_50kb_reps_wrapper.sh
...
#$ -cwd
#$ -j y
#$ -N angsd_thetas_50kb_reps_${pop1}
#$ -o ${prodir}/bash/jobs/angsd_thetas_50kb_reps_${pop1}.log
#$ -m bea
#$ -M connellym@si.edu
#
# ----------------Modules------------------------- #
...
printf '/share/apps/bioinformatics/angsd/0.941/angsd/misc/thetaStat do_stat ${angsddir}/thetas/%s.reps.thetas.idx -win 50000 -step 50000 -type 2 -outnames ${angsddir}/thetas/windows_50kb/%s.thetas.50kb.non-overlap.reps \n' "$pop1" "$pop1" >> $JOBFILE
