...
echo "sharkmer \
 --max-reads 6000000 -k 21 \
 -s ${SAMPLE} -o ${prodir}/outputs/sharkmer/${SAMPLE}/ \
  --pcr "TTTGGGSATTCGTTTAGCAG,SCCAATATGTTAAACASCATGTCA,1500,mtORF,coverage=15,mismatches=1,trim=24" \
  --pcr "ATTCAGTCTCACTCACTCACTCAC,TATCTTCGAACAGACCCACCAAAT,1500,PocHistone,coverage=15,mismatches=1,trim=24" \
