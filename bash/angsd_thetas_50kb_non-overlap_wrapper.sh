...
printf '/share/apps/bioinformatics/angsd/0.941/angsd/misc/thetaStat do_stat ${angsddir}/thetas/%s.thetas.idx -win 50000 -step 50000 -outnames ${angsddir}/thetas/windows_50kb/%s.thetas.50kb.non-overlap \n' "$pop1" "$pop1" >> $JOBFILE
