...
printf '/share/apps/bioinformatics/angsd/0.941/angsd/misc/thetaStat do_stat ${angsddir}/thetas/%s.thetas.idx -win 10000 -step 10000 -outnames ${angsddir}/thetas/windows_10kb/%s.thetas.10kb.gz \n' "$pop1" "$pop1" >> $JOBFILE
