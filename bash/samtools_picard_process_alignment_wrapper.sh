...
#$ -pe mthread 4
#$ -q mThM.q
#$ -l mres=32G,h_data=8G,h_vmem=8G" >> ${prodir}/bash/jobs/${sample}_samtools_picard.job
echo "#$ -j y
...
METRICS_FILE=${prodir}/outputs/alignments/${sample}_marked_dup_metrics.txt" >> $prodir/bash/jobs/${sample}_samtools_picard.job
echo "#" >> $prodir/bash/jobs/${sample}_samtools_picard.job
#
