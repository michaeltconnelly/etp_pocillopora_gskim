...
do
     ...
     # psbA genes
     # C. latusorum
     blastn -query ${prodir}/data/seqs/C_lat_psbA_MW819757.fasta -db ${prodir}/outputs/noncoral_spades/blastdbs/${base} -outfmt "6 qseqid sseqid pident length mismatch gapopen qstart qend sstart send evalue bitscore qlen slen qcovs" -perc_identity 98 -qcov_hsp_perc 75 -evalue 1e-6 -out ${prodir}/outputs/noncoral_spades/psbA_blast_hits/${base}_C_lat_psbA
