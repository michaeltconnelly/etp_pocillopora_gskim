...
do
     ...
     # psbA genes
     # C. latusorum
     blastn -query ${prodir}/data/seqs/C_lat_psbA_MW819757.fasta -db ${prodir}/outputs/noncoral_spades/blastdbs/${base} -outfmt "6 qseqid sseqid pident length mismatch gapopen qstart qend sstart send evalue bitscore qlen slen qcovs" -perc_identity 98 -qcov_hsp_perc 50 -evalue 1e-6 -out ${prodir}/outputs/noncoral_spades/psbA_blast_hits/${base}_C_lat_psbA
     ...
     # C. pacificum 
     blastn -query ${prodir}/data/seqs/C_pac_psbA_MW861711.fasta -db ${prodir}/outputs/noncoral_spades/blastdbs/${base} -outfmt "6 qseqid sseqid pident length mismatch gapopen qstart qend sstart send evalue bitscore qlen slen qcovs" -perc_identity 98 -qcov_hsp_perc 50 -evalue 1e-6 -out ${prodir}/outputs/noncoral_spades/psbA_blast_hits/${base}_C_pac_psbA
     ...
     # D. glynni
     blastn -query ${prodir}/data/seqs/D_gly_psbA_KY114947.fasta -db ${prodir}/outputs/noncoral_spades/blastdbs/${base} -outfmt "6 qseqid sseqid pident length mismatch gapopen qstart qend sstart send evalue bitscore qlen slen qcovs" -perc_identity 98 -qcov_hsp_perc 50 -evalue 1e-6 -out ${prodir}/outputs/noncoral_spades/psbA_blast_hits/${base}_D_gly_psbA
