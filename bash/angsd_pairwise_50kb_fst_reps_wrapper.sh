...
printf '/share/apps/bioinformatics/angsd/0.941/angsd/misc/realSFS fst stats2 ${angsddir}/fst/%s_%s.reps.fst.idx -win 50000 -step 50000 -type 2 > ${angsddir}/fst/%s_%s_50kb_reps_fst_results.txt \n' "$pop1" "$pop2" "$pop1" "$pop2" >> $JOBFILE
