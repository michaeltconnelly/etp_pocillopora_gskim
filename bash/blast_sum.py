...
txt_dir = "/scratch/nmnh_corals/connellym/projects/etp_pocillopora_gskim/outputs/noncoral_spades/mtcob_blast_hits"

# output text path
out_txt = "/scratch/nmnh_corals/connellym/projects/etp_pocillopora_gskim/outputs/noncoral_spades/mtcob_blast_hits_summary.txt"
