...
```{r}
#Running sNMF
obj.snmf = snmf("./outputs/oury_pipeline/Calls_1559SNP_DP3.geno", K=2:12, project="new", ploidy=2, CPU=2,
repetitions=5, entropy=T, iterations = 500)
pdf("./outputs/figures/snmf_cross_entropy_plot.pdf")
...
path <- "./outputs/oury_pipeline/snmf" #set output path
for (g in 2:k){
for (i in 1:n){
