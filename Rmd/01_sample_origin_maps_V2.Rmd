...
elevMapTest <-
  ...
  #
  geom_label_repel(aes(x = Longitude, y = Latitude, label = sum), size = 2, box.padding = 0.65, min.segment.length = 2, seed = 3, data = regions_ngsadmix_pops) +
  labs(x="Longitude", y="Latitude", elevation = "Elevation") +
...
pdf("./outputs/figures/Fig1C_ngsadmix_k6_map.pdf", width = 6.65, height = 4)
elevMapTest
dev.off()
```
