...
regions_ngsadmix_pops$Region_Label_Number <- paste0(regions_ngsadmix_pops$Region_Label, "\n(", regions_ngsadmix_pops$sum, ")")
```
```{r}
par(mar = c(0.5, 0.5, 0.5, 0.5))
elevMapTest <-
  ...
  #
  geom_label_repel(aes(x = Longitude, y = Latitude, label = Region_Label_Number), size = 2, box.padding = 0.72, min.segment.length = 2, seed = 3, data = regions_ngsadmix_pops) +
  annotation_scale(location = "bl", width_hint = 0.3, height = unit(0.2, "cm"),) + 
...
pdf("./outputs/figures/Fig1C_ngsadmix_k5_map_numbers.pdf", width = 6.65, height = 3.05)
elevMapTest
dev.off()
```
