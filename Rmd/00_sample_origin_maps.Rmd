...
# NOTE: these maps are only good for 100 km scale
# Panama - Perlas, Coiba
panama <- getNOAA.bathy(lon1 = -83, lon2 = -77,
                        lat1 = 6, lat2 = 10, resolution = 1)

# Panama and Costa Rica - Perlas, Coiba, Coco
panama_costarica <- getNOAA.bathy(lon1 = -88, lon2 = -76,
