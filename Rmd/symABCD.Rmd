...
```{r}
abcd_pdam <- read.delim("./outputs/symbiont_counts/allcounts_symABCD.txt")
...
```
```{r}
pdf("./outputs/figures/nobones/pocillopora_symbiont_proportions_species_facet.pdf", width = 8.5, height = 4.75)
...
```
```{r}
pdf("./outputs/figures/pocillopora_spp_symbiont_proportions_galapagos.pdf", width = 6.5, height = 6.5)
print(plot_abcd_pdam)
dev.off()
```
