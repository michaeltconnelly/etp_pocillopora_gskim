...
```
```{r}
pdf("./outputs/figures/sicb/pocillopora_symbiont_proportions_species_facet.pdf", width = 7, height = 4.75)
...
df_abcd_pdam %<>% filter(`Sample ID` %in% samples_noclones$`Sample ID`)
