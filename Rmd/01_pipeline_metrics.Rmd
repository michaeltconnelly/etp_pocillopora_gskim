...
## Import/inspect lcWGS pipeline QC metrics
...
```{r}
mqc <- multiqc_data %>%
  inner_join(samples, by = "Sample ID") %>% pivot_longer(., `Raw Reads`:`Mapped Reads`, names_to = "pipeline_step", values_to = "read_count", names_transform = list("pipeline_step" = as_factor))
#
