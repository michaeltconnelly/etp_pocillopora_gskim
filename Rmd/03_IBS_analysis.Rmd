...
etp_samples <- read_csv("./data/pana_manu.txt", col_names = "Sample ID")
```
```{r select_samples}
...
bams <- read.table("/Users/mikeconnelly/computing/projects/etp_pocillopora_gskim/outputs/angsd/all_bamfile.txt",header=F)[,1]
...
all(samples$`Sample ID` %in% bams) # TRUE
