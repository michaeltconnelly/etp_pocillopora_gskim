...
#
east_pacific <- getNOAA.bathy(lon1 = -120, lon2 = -74,
...
autoplot(panama, geom=c("r", "c"), colour="white", size=0.1) + scale_fill_etopo()
```
```{r}
...
```{r}
autoplot(east_pacific, geom=c("r", "c"), colour="white", size=0.1) + scale_fill_etopo()
```
