...
```
```{r}
all_samples <- read_csv("./data/pocillopora_samples_002.csv")
stri_samples <- read_csv("./data/stri_samples.txt")
```
```{r}
...
site_colors <- c("blue", "darkblue", "steelblue", "lightblue", "darkorange3","darkorange", "orange", "orangered", "cyan", "cyan3", "cyan4", "cornflowerblue")
```
