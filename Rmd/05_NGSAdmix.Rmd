...
# read in the data 
q <- read_table("./outputs/ngsadmix/phyluce_noclones_K4.qopt", col_names = c("pop1","pop2","pop3","pop4"))

# read in the population information file located in the bam.filelist
pop <- read_table("./data/phyluce_noclones_samples.txt", col_names = "Sample ID") %>% 
...
for (i in 2:maxK){
  ...
  # print(kcols)
  qopt_list[[i]] <- read_table(paste0("./outputs/ngsadmix/phyluce_noclones_K",i,".qopt"), col_names = kcols)
}
qopt_list
```
