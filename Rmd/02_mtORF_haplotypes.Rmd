...
samples <- all_samples
# NOTE: Perform mtORF barcoding for all samples before clone correction
```
...
mtorf_types <- c(I = "Type 3a", II = "Type 3b", III = "Type3m", IV = "Type 1a", V = "Type 2")
ORF_types <- c(I = "ORF46", II = "ORF47", III = "ORFNN", IV = "ORF27", V = "ORF01")
#
...
```{r figure ##: powerpoint}
pdf(file="./outputs/figures/sicb/mtORF_haplotypes_type.pdf", width = 4.5, height = 3, pointsize = 6)
plot(dataNet,
